...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: master
        image: index.alauda.cn/googlecontainer/redis:e2e  # or just image: redis
        resources:
          requests:
            cpu: 100m
            memory: 100Mi
...
Containers:
  master:
    ...
    Image:		index.alauda.cn/googlecontainer/redis:e2e
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: slave
        image: index.alauda.cn/google_samples/gb-redisslave:v1
        resources:
          requests:
            cpu: 100m
            memory: 100Mi
